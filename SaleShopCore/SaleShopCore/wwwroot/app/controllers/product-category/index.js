        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            lukas.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        lukas.notify('Deleted success', 'success');
                        lukas.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        lukas.notify('Update success', 'success');
                    ...
                    error: function () {
                        lukas.notify('Has an error in update progress', 'error');
                        lukas.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = lukas.unflattern(data);
