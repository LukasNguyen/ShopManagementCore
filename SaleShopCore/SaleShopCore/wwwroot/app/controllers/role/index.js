    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        lukas.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        lukas.notify('Has an error', 'error');
                        lukas.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            lukas.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    error: function (status) {
                        lukas.notify('Has an error in deleting progress', 'error');
                        lukas.stopLoading();
                    }
                });
            });
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    lukas.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    lukas.stopLoading();
                },
                error: function () {
                    lukas.notify('Has an error in save permission progress', 'error');
                    lukas.stopLoading();
                }
            });
        });
